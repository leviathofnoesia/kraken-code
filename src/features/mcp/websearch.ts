...
import type { MCPServerDefinition, MCPTool, WebsearchConfig, WebsearchResult } from './types'
...
const websearchToolImpl = tool({
  description:
    'Search the web for information using AI-powered search via Exa AI. Returns relevant web pages with their content.',
  args: {
...
const webfetchToolImpl = tool({
  description:
    'Fetch and parse web content from a specific URL using Exa AI. Returns the content in the specified format.',
  args: {
